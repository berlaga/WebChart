...
namespace WebChart.Web
{
    ...
    public partial class ELMAH_Entities : DbContext
    {
        public ELMAH_Entities()
            : base("name=ELMAH_Entities")
        {
        }
        ...
        public virtual ObjectResult<ELMAH_report_Result> ELMAH_report(Nullable<int> distinctErrorTypes, Nullable<int> daysBack)
        {
            var distinctErrorTypesParameter = distinctErrorTypes.HasValue ?
                new ObjectParameter("DistinctErrorTypes", distinctErrorTypes) :
                new ObjectParameter("DistinctErrorTypes", typeof(int));
    
            var daysBackParameter = daysBack.HasValue ?
                new ObjectParameter("DaysBack", daysBack) :
                new ObjectParameter("DaysBack", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ELMAH_report_Result>("ELMAH_report", distinctErrorTypesParameter, daysBackParameter);
        }
    }
}
